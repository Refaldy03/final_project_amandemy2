...
@section('content')
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-sm-12">
                <a class="btn btn-outline-dark mb-4 fw-bold" href="{{ route('produk') }}"><svg class="me-2"
                        ...
                        <div class="col-md-8 offset-2">
                            ...
                            <div class="card">
                                <div class="card-body rounded px-4" style="background-color: rgba(70, 130, 180)">
                                    ...
                                    <form class="mt-3" action="{{ route('produk.update', ['id' => $produk->id]) }}"
                                        ...
                                        <div class="d-flex">
                                            <div class="mx-auto my-2">
                                                <a href="{{ route('produk') }}" class="btn btn-warning me-2">
                                                    Kembali</a>
